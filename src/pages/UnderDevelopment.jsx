export default function UnderDevelopment() {
  return (
    <main className="min-h-screen bg-[#0f6a3c] flex items-center justify-center px-6 py-10">
      <section className="relative w-full max-w-4xl overflow-hidden rounded-3xl bg-[#1d8a53] px-6 py-16 text-center shadow-2xl sm:px-10">
        <div className="pointer-events-none absolute left-1/2 top-6 h-44 w-40 -translate-x-1/2 rounded-2xl bg-[#b39ddb]/80 blur-[18px]" />
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-[#0f6a3c]/35" />
        <div className="relative">
          ...
          <button
            type="button"
            className="mt-10 rounded-lg bg-[#b39ddb] px-8 py-3 text-sm font-semibold text-[#12351f] transition hover:bg-[#c3afe3]"
          >
            Notify Me
          </button>
        </div>
