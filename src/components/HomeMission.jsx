...
export default function HomeMission() {
  return (
    <section 
      ...
      style={{ backgroundImage: 'url("/images/animals-bg.png")' }}
    >
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Mobile/Tablet View: Bento Grid */}
        <motion.div
          initial="hidden"
          whileInView="show"
        ...
        >
          {/* Card 1 — Large: Title (spans 2 cols, 2 rows) */}
          <motion.div
            variants={item}
          ...
          >
            <div className="flex items-center gap-2 sm:gap-3 mb-2 sm:mb-4">
              <img src="/images/cropped-cropped-gooo-1-1.png" alt="" className="w-8 h-8 sm:w-10 sm:h-10 rounded-full object-cover shadow-sm" />
              <span className="text-[10px] sm:text-xs font-bold text-charcoal/80 bg-white/50 px-2 py-0.5 sm:px-3 sm:py-1 rounded-full backdrop-blur-sm">Trusted since 2015</span>
            </div>
            <h2 className="font-display text-base sm:text-3xl md:text-4xl font-bold text-charcoal leading-snug sm:leading-[1.12] drop-shadow-sm">
              Empowering growth through sustainable agriculture
            </h2>
            <Button to="/about" size="sm" className="shadow-lg mt-2 sm:mt-4 w-fit sm:!px-6 sm:!py-3 sm:text-base">
              Learn more
            </Button>
          </motion.div>

          {/* Card 2 — Tall: Stats (1 col, 2 rows) */}
          <motion.div
            variants={item}
          ...
          >
            <div>
              <p className="text-[10px] sm:text-xs font-semibold uppercase tracking-wider text-white/70 mb-0.5 sm:mb-1">National Reach</p>
              <p className="font-display text-2xl sm:text-5xl font-bold text-white">
                <AnimatedCounter value={500} from={1} suffix="+" duration={2} />
              </p>
              <p className="text-[10px] sm:text-sm text-white/70 mt-0.5 sm:mt-1 leading-tight">Farms served across Ghana</p>
            </div>
            <AnimatedProgressBar
              percent={75}
              duration={2}
          ...
          {/* Card 3 — Square: Image (1 col, 2 rows) */}
          <motion.div
            variants={item}
          ...
          >
            <img
              src="/images/Raafortagro-2.png"
              alt="Livestock"
              className="w-full h-full object-cover"
            />
          </motion.div>

          {/* Card 4 — Wide: Description (2 cols, 1 row) */}
          <motion.div
            variants={item}
          ...
          >
            <span className="font-display text-base sm:text-xl font-bold text-forest mb-0.5 sm:mb-1">01</span>
            <h3 className="font-display font-bold text-charcoal text-xs sm:text-sm leading-snug">Premium genetics</h3>
            <p className="text-xs text-charcoal/60 mt-0.5 hidden sm:block">Day-old chicks from trusted stock.</p>
          </motion.div>

          {/* Card 6 — Benefit 02 (1 col, 1 row) */}
          <motion.div
            variants={item}
            className="col-span-1 row-span-1 bg-beige/80 backdrop-blur-lg rounded-2xl sm:rounded-3xl p-3 sm:p-5 shadow-lg sm:shadow-xl border border-beige-dark/20 flex flex-col justify-center"
          >
            <span className="font-display text-base sm:text-xl font-bold text-forest mb-0.5 sm:mb-1">02</span>
            <h3 className="font-display font-bold text-charcoal text-xs sm:text-sm leading-snug">Smart delivery</h3>
            <p className="text-xs text-charcoal/60 mt-0.5 hidden sm:block">Nationwide live-animal logistics.</p>
          </motion.div>

          {/* Card 7 — Wide: CTA + Social (2 cols, 1 row) */}
          <motion.div
            variants={item}
          ...
          >
            <p className="text-white text-[11px] sm:text-base font-medium leading-snug">
              Premium poultry, livestock & feed — from hatch to harvest.
            </p>
        ...
        <div className="hidden lg:grid grid-cols-2 gap-10 lg:gap-16 items-start">
          <RevealGrid className="bg-white/50 backdrop-blur-lg border border-white/40 rounded-3xl p-6 sm:p-10 shadow-2xl">
            <RevealItem className="flex items-center gap-3 mb-6">
              <img src="/images/cropped-cropped-gooo-1-1.png" alt="" className="w-12 h-12 rounded-full object-cover shadow-sm" />
              <span className="text-sm font-bold text-charcoal/80 bg-white/50 px-3 py-1 rounded-full backdrop-blur-sm">Trusted since 2015</span>
            </RevealItem>
            <RevealItem>
            ...
            <RevealItem className="flex items-center gap-6">
              <Button to="/about" size="lg" className="shadow-lg shrink-0">
                Learn more
              </Button>
              <p className="text-sm font-medium text-charcoal/80 max-w-xs leading-relaxed">
                Premium poultry, livestock, and feed — from hatch to harvest, delivered with care.
              </p>
            </RevealItem>
          </RevealGrid>
          ...
          <div className="space-y-6">
            ...
            >
              <p className="text-xl text-charcoal leading-relaxed font-semibold drop-shadow-sm">
                We offer innovative solutions to significantly enhance poultry and livestock yields for Ghanaian
                farmers.
              </p>
            </motion.div>
